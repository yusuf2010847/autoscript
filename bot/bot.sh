...
cd /usr/bin
wget https://raw.githubusercontent.com/yusuf2010847/autoscript/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/yusuf2010847/autoscript/main/bot/kyt.zip
unzip kyt.zip
